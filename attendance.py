...
def gettt(token):
    ...
    payload = {
        "sharedBy": "srm_university", "appLinkName": "academia-academic-services", "viewLinkName": "My_Time_Table_2020_21_Even",
        "zccpn": token['zccpn'],
    ...
    s1 = """$("#zc-viewcontainer_My_Time_Table_2020_21_Even").prepend(pageSanitizer.sanitize('"""
    s2 = """});</script>"""
